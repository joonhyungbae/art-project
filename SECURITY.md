...
1. Go to the [Security Advisories](https://github.com/joonhyungbae/art-paper/security/advisories) page.
...
- Feature requests or general bugs — use [Issues](https://github.com/joonhyungbae/art-paper/issues) instead
