...
### Example 1 — Vague pull, no concept yet (`/art-socratic`)
...
### Example 2 — Stuck, need provocations (`/art-provoke`)
...
### Example 3 — Position against lineage (`/art-lineage`)
...
### Example 4 — Need a one-pager for a grant deadline (`/art-brief`)
...
### Example 5 — Rehearse before facing real reviewers (`/art-rehearsal`)
...
### Example 6 — Open a long-running project file (`/art-ideate`)
...
| Your situation | Mode |
|---|---|
| Vague pull, no concept yet | `/art-socratic` |
| Stuck, need provocations | `/art-provoke` |
| Have candidate lineage, want extension | `/art-lineage` |
| Need a proposition document (grant, residency, expo) | `/art-brief` |
| Have a brief, want rehearsal before submission | `/art-rehearsal` |
| Want to track a long-running project across sessions | `/art-ideate` |
