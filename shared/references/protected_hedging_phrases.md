...
4. **Calibration is mode-specific.** Deep-research INSIGHT abstracts and art-paper journal abstracts have different convention (see `word_count_conventions.md`). Calibration runs once per target mode, not once per paper.
...
- `ref/academic-research-skills/docs/design/2026-04-29-ars-v3.6.7-downstream-agent-pattern-protection-spec.md` §3.3 (C1) — pattern definition and provenance.
