...
Spec: `ref/academic-research-skills/docs/design/2026-04-23-ars-v3.6.2-sprint-contract-design.md`.
Protocol: `art-reviewer/references/sprint_contract_protocol.md`.
...
2. Run `python scripts/check_sprint_contract.py <path> --art-paper-version vX.Y.Z`; expect
...
- `passport/audit_artifact_entry.schema.json` (v3.6.7 Step 6) — `audit_artifact[]` entries
  ...
  `ref/academic-research-skills/docs/design/2026-04-30-ars-v3.6.7-step-6-orchestrator-hooks-spec.md` §3.1-§3.2.
...
Spec: `ref/academic-research-skills/docs/design/2026-04-30-ars-v3.6.7-step-6-orchestrator-hooks-spec.md` §3.
