...
version: 1.0.0
owner_skill: shared
invoked_by: [art-pipeline, art-inquiry, art-paper]
data_access_level: verified_only
task_type: open-ended
status: active
related_skills: [art-pipeline, art-inquiry, art-paper]
...
related_protocols:
  ...
  - art-paper/references/anti_leakage_protocol.md
  - art-pipeline/references/ai_research_failure_modes.md
---
...
| Mode/context mismatch (e.g. `art-paper full` passes SR mode) | Refuse with `{decision: "abort", reason: "mode/context mismatch"}`. Orchestrator must re-evaluate and re-invoke. |
...
- `art-paper/references/anti_leakage_protocol.md` — gap-marking discipline
- `art-pipeline/references/pipeline_state_machine.md` — FAIL-loop integration
