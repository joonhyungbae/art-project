...
- **Primary entry point**: `art-paper/agents/intake_agent` Step 10 (optional)
- **Pipeline carry**: `art-pipeline` Material Passport carries the Style Profile across all stages
- **Consumers**: `art-paper/agents/draft_writer_agent`, `art-inquiry/agents/report_compiler_agent`
