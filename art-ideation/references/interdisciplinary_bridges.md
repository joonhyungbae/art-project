...
**Example 2: "A Generative-AI Portrait Work"**

| Discipline | How the Problem Is Defined | Core Concepts | Typical Methods | Possible Readings / Moves |
|-----------|---------------------------|---------------|-----------------|-------------------|
| Art History / Theory | Where the work sits in the lineage of portraiture and the gaze | Portraiture, the gaze, authorship, the index | Iconographic analysis, close reading, lineage tracing | Position against precedents; make the authorship question the subject |
| Media / Cultural Studies | How the trained model encodes and circulates representation | Representation, dataset bias, surveillance, circulation | Critical analysis, discourse analysis | Foreground the dataset's provenance; expose the apparatus |
| Computer Science / HCI | What the system technically does and how viewers perceive it | Generative models, latent space, perceived realism | System description, perception study | Make the model's mechanism legible; (Pattern-5) measure perceived realism |
| Law / Ethics | Whose likeness and rights are engaged by training and output | Likeness rights, consent, copyright, moral rights | Rights analysis, consent protocols | Secure consent/licensing; disclose provenance; courtesy lines |

**Interdisciplinary Integration Perspective**: The work is impoverished if framed only technically (CS's "novel pipeline") while ignoring the theory dimension (what the gaze means), the cultural dimension (whose faces, from what data), and the ethics dimension (likeness consent). The strongest art papers braid these — see `shared/references/art_research_evidence_model.md` on triangulating work / process / lineage / reflection.
...
- Good: "How does an AI-generated portrait series complicate the viewer's sense of who is being looked at?"
- Not good: "AI art raises many questions" (too vague)
...
- Ask yourself: Who else is dealing with a similar problem? (Generative portraiture → psychologists study face perception; media theorists study the gaze)
- Ask yourself: What are the upstream/downstream aspects of this problem? (Training data → upstream is image collection/consent, downstream is reception and circulation)
