...
Full walkthroughs in the [wiki](https://apesuite.org/plugins/) and [QUICKSTART.md](QUICKSTART.md).

---

## What the six modes do
...
| `/art-project:provoke` | 8–20 tradition-tagged provocations with [Authentic Practice Boundary](https://apesuite.org/plugins/#/art-project/en/reference/authentic-practice-boundaries) per method | **Preserved unhelpfulness** — silence after delivery, no auto-interpretation, no ranking |
