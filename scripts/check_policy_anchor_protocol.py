...
Decision Doc reference:
  ref/academic-research-skills/docs/design/2026-05-14-ai-disclosure-schema-decision.md §4.1 (item 6) +
  §4.3 invariants + §4.4 11 open concerns + §3 G10 7-row precedence table.

Implementation spec reference:
  ref/academic-research-skills/docs/design/2026-05-14-ai-disclosure-impl-spec.md §3 (resolved-paths table).
...
Usage
-----
  python scripts/check_policy_anchor_protocol.py art-paper/references/policy_anchor_disclosure_protocol.md
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "path",
        nargs="?",
        default="art-paper/references/policy_anchor_disclosure_protocol.md",
