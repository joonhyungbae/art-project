...
Per ref/academic-research-skills/docs/design/2026-05-18-ars-v3.9.4-temporal-verification-spec.md §7.
"""
...
def test_timeline_extraction_agent_has_phase_boundary_block():
    agent_path = REPO_ROOT / "art-inquiry/agents/timeline_extraction_agent.md"
...
def test_m3_iron_rule_present_in_report_compiler():
    path = REPO_ROOT / "art-inquiry/agents/report_compiler_agent.md"
...
def test_m3_iron_rule_present_in_draft_writer():
    path = REPO_ROOT / "art-paper/agents/draft_writer_agent.md"
    content = path.read_text()
    assert M3_IRON_RULE_MARKER in content
    for phrase in M3_KEY_PHRASES:
