...
Decision Doc reference:
  ref/academic-research-skills/docs/design/2026-05-14-ai-disclosure-schema-decision.md §4.1 (item 6a)
  + §4.3 invariants.

Implementation spec reference:
  ref/academic-research-skills/docs/design/2026-05-14-ai-disclosure-impl-spec.md §2.1 (file map) + §4
...
Usage
-----
  python scripts/check_policy_anchor_table.py art-paper/references/policy_anchor_table.md
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "path",
        nargs="?",
        default="art-paper/references/policy_anchor_table.md",
        help="path to policy_anchor_table.md (default: %(default)s)",
    )
    parser.add_argument(
        "--venue-policies",
        default="art-paper/references/venue_disclosure_policies.md",
