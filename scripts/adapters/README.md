...
Reference adapters that produce `literature_corpus[]` entries for the ARS Material Passport. Defined by the adapter contract at [`art-pipeline/references/adapters/overview.md`](../../art-pipeline/references/adapters/overview.md).
...
1. Read the adapter contract at [`art-pipeline/references/adapters/overview.md`](../../art-pipeline/references/adapters/overview.md).
