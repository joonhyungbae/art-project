...
(`art-paper/agents/formatter_agent.md`) MUST refuse on. The annotation
...
2. `art-paper/agents/formatter_agent.md` REFUSE rules 6-10 (the
...
Spec: ref/academic-research-skills/docs/design/2026-05-15-issue-103-claim-alignment-audit-spec.md §5.
...
FORMATTER_AGENT = REPO_ROOT / "art-paper" / "agents" / "formatter_agent.md"
