...
`art-pipeline/agents/claim_ref_alignment_audit_agent.md` is cleared by
the regression test below.

Spec: ref/academic-research-skills/docs/design/2026-05-15-issue-103-claim-alignment-audit-spec.md §7.6 + §13 step 9.
