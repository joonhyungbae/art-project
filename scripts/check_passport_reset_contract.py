...
Contract: any text file that mentions the env-flag token `CRS_PASSPORT_RESET`
...
# CRS_PASSPORT_RESET token from prior work without owing the protocol-doc
# co-location.
SKIP_DIRS = {
    ".git",
    "node_modules",
