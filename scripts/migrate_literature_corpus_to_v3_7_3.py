...
Design: ref/academic-research-skills/docs/design/2026-05-15-issue-105-contamination-signals-backfill-design.md
"""
...
def _build_default_ss_client() -> cs.SemanticScholarClient:
    """Production SS client per art-inquiry/references/semantic_scholar_api_protocol.md
