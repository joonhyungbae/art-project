...
ORCHESTRATOR_PATH = Path("art-pipeline/agents/pipeline_orchestrator_agent.md")
PIPELINE_SKILL_PATH = Path("art-pipeline/SKILL.md")
AGENTS_DIR = Path("art-pipeline/agents")
