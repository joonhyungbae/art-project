...
Spec: ref/academic-research-skills/docs/design/2026-05-18-ars-v3.9.2-phase-boundary-spec.md Phase 5
Classification: ref/academic-research-skills/docs/design/2026-05-18-ars-v3.9.2-agent-phase-classification.md
...
# Source: ref/academic-research-skills/docs/design/2026-05-18-ars-v3.9.2-agent-phase-classification.md
BUCKET_A_AGENTS = [
    # art-inquiry/agents/ (10)
    "art-inquiry/agents/research_question_agent.md",
    "art-inquiry/agents/research_architect_agent.md",
    "art-inquiry/agents/bibliography_agent.md",
    "art-inquiry/agents/source_verification_agent.md",
    "art-inquiry/agents/synthesis_agent.md",
    "art-inquiry/agents/timeline_extraction_agent.md",  # v3.9.4 Phase 2 sibling
    "art-inquiry/agents/editor_in_chief_agent.md",
    "art-inquiry/agents/ethics_review_agent.md",
    "art-inquiry/agents/risk_of_bias_agent.md",
    "art-inquiry/agents/meta_analysis_agent.md",
    # art-paper/agents/ (7)
    "art-paper/agents/literature_strategist_agent.md",
    "art-paper/agents/structure_architect_agent.md",
    "art-paper/agents/draft_writer_agent.md",
    "art-paper/agents/citation_compliance_agent.md",
    "art-paper/agents/abstract_agent.md",
    "art-paper/agents/peer_reviewer_agent.md",
    "art-paper/agents/formatter_agent.md",
    # art-reviewer/agents/ (6)
    "art-reviewer/agents/eic_agent.md",
    "art-reviewer/agents/methodology_reviewer_agent.md",
    "art-reviewer/agents/domain_reviewer_agent.md",
    "art-reviewer/agents/perspective_reviewer_agent.md",
    "art-reviewer/agents/devils_advocate_reviewer_agent.md",
    "art-reviewer/agents/editorial_synthesizer_agent.md",
]
...
BUCKET_BCD_AGENTS = [
    ...
    "art-inquiry/agents/devils_advocate_agent.md",          # P1, 3, 5 + Socratic L2, 4
    "art-inquiry/agents/report_compiler_agent.md",          # P4, 6
    "art-paper/agents/argument_builder_agent.md",        # P3 + Plan Step 3
    "art-paper/agents/visualization_agent.md",           # P4 + P7
    # Bucket C — phase-orthogonal (8)
    "art-inquiry/agents/socratic_mentor_agent.md",          # Socratic Layer 1-5
    "art-paper/agents/socratic_mentor_agent.md",         # Plan Step 0-3
    "art-inquiry/agents/monitoring_agent.md",               # post-pipeline
    "art-paper/agents/revision_coach_agent.md",          # Revision-Coach standalone
    "art-pipeline/agents/integrity_verification_agent.md",  # Stage 2.5 / 4.5 gates
    "art-pipeline/agents/collaboration_depth_agent.md",  # FULL/SLIM advisory
    "art-pipeline/agents/claim_ref_alignment_audit_agent.md",  # opt-in audit
    "shared/agents/compliance_agent.md",                      # cross-skill stage gates
    # Bucket D — cross-phase / meta (4)
    "art-paper/agents/intake_agent.md",                  # Phase 0 cross-phase config
    "art-pipeline/agents/pipeline_orchestrator_agent.md",  # orchestrator
    "art-pipeline/agents/state_tracker_agent.md",        # meta state
    "art-reviewer/agents/field_analyst_agent.md",  # Phase 0 configures panel
]
...
def check_bucket_a(path: Path) -> list[str]:
    ...
    if block is None:
        errors.append(
            ...
            f"ref/academic-research-skills/docs/design/2026-05-18-ars-v3.9.2-agent-phase-classification.md)"
        )
        return errors
