...
REF_DOC_PATH = REPO_ROOT / "art-pipeline" / "references" / "literature_corpus_consumers.md"
...
REF_DOC_BACKPOINTER = "art-pipeline/references/literature_corpus_consumers.md"
...
# basename entries.
_BIBLIO_ENTRY = ("bibliography_agent", "art-inquiry/agents/bibliography_agent.md")
_STRAT_ENTRY = (
