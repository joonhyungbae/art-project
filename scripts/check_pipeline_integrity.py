...
Spec: ref/academic-research-skills/docs/design/2026-05-18-ars-v3.9.2-phase-boundary-spec.md Phase 4
...
# art-pipeline Stage 3 review protocol. At least one from each category
...
def format_text(report: Report) -> str:
    ...
    lines.append("See ref/academic-research-skills/docs/design/2026-05-18-ars-v3.9.2-phase-boundary-spec.md for rationale.")
    return "\n".join(lines)
