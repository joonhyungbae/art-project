...
Spec:
  ref/academic-research-skills/docs/design/2026-05-15-issue-103-claim-alignment-audit-spec.md §5 (8-row
...
# Set of annotation prefixes that `/art-mark-read` CANNOT clear — structural
...
def art_paper_mark_read_clears(*, annotation: str, tier: str) -> bool:
    """Return True iff `/art-mark-read` can promote the annotation to cleared state.
