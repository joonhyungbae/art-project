...
Per spec §7.5 in
ref/academic-research-skills/docs/design/2026-05-15-issue-103-claim-alignment-audit-spec.md.
...
# constant-name drift; this except handles only the absent-module case.
    ...
    art_paper_mark_read_clears = _stub  # type: ignore[assignment]
...
# ---------------------------------------------------------------------------
# T-F3 — /art-mark-read does NOT clear HIGH-WARN-CLAIM-NOT-SUPPORTED (asymmetry).
# ---------------------------------------------------------------------------
